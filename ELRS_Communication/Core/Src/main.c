...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define MAX_STRING_LENGTH 100 // Adjust the size based on your expected string length
/* USER CODE END PD */
